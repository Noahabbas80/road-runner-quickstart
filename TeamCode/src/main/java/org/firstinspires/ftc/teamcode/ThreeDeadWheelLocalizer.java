...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1377.7605871620112; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1428.9112722463706; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -1766.0272136100418; // x position of the perpendicular encoder (in tick units)
    }
